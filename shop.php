...
<body>
    ...
    <div class="landing-page" style="font-size: .2em">
        <p>Welcome to our marketplace</p>
        <img src="https://i.pinimg.com/originals/9a/ee/ce/9aeeceef9542e2a19d45bb472df4562c.png" width="300" height="200" alt="Image Description">
    </div>
    <div class="main-page">
...
?>
        <h1>Nedavno dodano</h1>
            <hr>
            <div class="proizvodi">
                <?php
            $sql = "SELECT * FROM (SELECT * FROM proizvodi ORDER BY id DESC LIMIT 4) AS subquery ORDER BY id ASC";
